...
public class ITboutonsModifier extends javax.swing.JFrame {
    ...
    try {
            ...
            String[] clients = rq.getClients().toArray(new String[0]);
            String[] noms = rq.getnomsClients().toArray(new String[0]);
          ...
          //  String[] lesInfos = rq.getInfosReservation(idReservation);
            ...
            if (!"".equals(dates[0])){
                ...
                if("client".equals(changement)){
                    ...
                    String[] lesClients = rq.getClients().toArray(new String[0]);
                    String[] nom = rq.getnomsClients().toArray(new String[0]);
