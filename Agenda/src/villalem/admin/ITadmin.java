...
import static villalem.admin.ITmodifUtilisateur.getNomPrenom;
...
public class ITadmin extends javax.swing.JFrame {
    ...
    //TODO rework toutes les requetes et leurs fonctionnements
        ...
        switch(nom){
            ...
            try {
                ...
                if(nomTache != null){
                    ...
                    modif.getLbNom().setVisible(false);
                    modif.getBtnCouleur().setBackground(rq.hex2Rgb(nomTache));
