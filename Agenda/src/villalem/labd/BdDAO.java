...
public class BdDAO {
	...
	public BdDAO(Connexion uneCo){
        ...
        */
         ...
         * @throws SQLException
         */
        public String[] getSalleTacheEntiteFormule(String table) throws SQLException, NullPointerException{
     ...
     */
        ...
        */
        ...
        public boolean autreReservation(String dateDebut, String dateFin) throws SQLException {
             ...
             */
            String request = "SELECT * FROM réservation WHERE '" + dateDebut + "' >= dateDebut"
