...
public class generationFacture{
	public void generer(int idResa) throws SQLException{
		
	    	
	    	//Recuperer montant, et crÈer facture dans la bdd
	        ...
	        */
	        ...
	        Fusion des cellules
	        */
	        sheet.addMergedRegion(new CellRangeAddress(0, 0, 0, 2)); // Fusionne les cellules de la ligne 0 √† la ligne 0 et colonnes 0 √† colonne 2
	        ...
	        /*
	        Redimensionnement des lignes et colonnes par d√©faut
	        */
	        ...
	        */
	        ...
	        for (int i = 0; i <= 5; ++i) {
	            ...
	            if (i == 0) {
	                cell.setCellValue("SociÈtÈ de production audiovisuelle");
	        ...
	        */
	        ...
	        cell = row.createCell(0);
	        cell.setCellValue("S√©bastien AUTRET");
	        cell.setCellStyle(cellStyleFont12);
	            ...
	            for(int j = 0 ; j <= 5 ; j++){
	            	...
	            	for(int k = 21;k<27;k++){
	            		...
	            		if(i == k && j==5 && optselib[k-21]!=null){
	            			cell.setCellValue(optseprix[k-21]+" Ä");
	            		}
	        ...
	        for(int i = 27 ; i <= 29 ; i++){
	            for(int j = 4 ; j <= 5 ; j++){
	                ...
	                if(j == 4){
	                    ...
	                    cell.setCellValue(dcf.format(lesPrix[i - 27])+" Ä");
	                }
	            }
	        }
