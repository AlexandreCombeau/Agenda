    ...
    private void btnEnregistrerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnregistrerActionPerformed
       try {
            ...
            if(comparerheures(horaireDebut, horaireFin, dateDebut, dateFin)){
            	...
            	JOptionPane.showMessageDialog(null, "La salle dans cette disposition est de capacit� insuffisante", "Erreur", JOptionPane.INFORMATION_MESSAGE);
            }
            else{
            //CLIENT
            ...
            if(!(existe.equals("Aucune"))){
               String nomSalle2 = (String)cbSalle2.getSelectedItem();
        		...
        		JOptionPane.showMessageDialog(null, "Salle d�j� r�serv�e pour ce cr�aneau");
        	}
            }
        } catch (SQLException ex) {
            Logger.getLogger(ITcreerReservation1.class.getName()).log(Level.SEVERE, null, ex);
