...
public class planningNotRec extends AbstractPlanning{
	...
	public void validation(int resadispo, String[] date, String[][] horaireDebut, String[][] horaireFin, String nbParticipants, double[][] nbHeures, int idClient, int[][] formule, int[] idinfosalle, String[][][] OS) throws SQLException{
