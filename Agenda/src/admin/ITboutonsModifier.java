...
public class ITboutonsModifier extends javax.swing.JFrame {
    ...
    try {
            ...
            if (client!=null){
                ...
                if (date!=null){
                    ...
                    String changement = "";
                    if (!"".equals(dates[0])){
                    	ITcreerReservation1 nouvelleResa = new ITcreerReservation1(new operationModif());
                    	nouvelleResa.setClient(client);
                    	nouvelleResa.setDisposition(disposition);
                    	nouvelleResa.setNbPersonne(nbpers);
                    	nouvelleResa.setDateDebut(date);
                    	nouvelleResa.setSalle(salle);
                    	nouvelleResa.setOptions(option);
                    	nouvelleResa.setServices(service);
                    	nouvelleResa.setDateFin(dateFin);
                    	nouvelleResa.setFormule(formule);
                    	nouvelleResa.setHeureDebut(heureD);
                    	nouvelleResa.setHeureFin(heureF);
                    	nouvelleResa.setTitle(Integer.toString(idReservation));
                        ...
                        if (changement!=null){
                            if("validite de la réservation(option)".equals(changement)){
                                ...
                                if (valide!=null){
                                    if ("valider reservation".equals(valide)){
                                        int valider = 1;
                                        rq.MAJIntfromId("reservation", "estValide", valider, idReservation, "idReservation");
                            ...
                            if("date de début".equals(changement)){
                                ...
                                if (dateDe!=null){
                                    rq.MAJStrfromId("reservation", "dateDebut", dateDe, idReservation, "idReservation");
                            ...
                            if("date de fin".equals(changement)){
                                ...
                                if (dateFi!=null){
                                	rq.MAJStrfromId("reservation", "dateFin", dateFi, idReservation, "idReservation");
                            ...
                            if("heure de début".equals(changement)){
                                ...
                                if (heureDe!=null){
                                	rq.MAJTimefromId("reservation", "heureDebut", heureDe, idReservation, "idReservation");
                            ...
                            if("heure de fin".equals(changement)){
                                ...
                                if (heureFi!=null){
                                	rq.MAJTimefromId("reservation", "heureFin", heureFi, idReservation, "idReservation");
                            ...
                            if("nombre de personnes".equals(changement)){
                                ...
                                if (nbP!=null){
                                    ...
                                    rq.MAJIntfromId("reservation", "nbPersonnes", nb, idReservation, "idReservation");
                            ...
                            if("nombre d'heures".equals(changement)){
                                ...
                                if (nbH!=null){
                                    ...
                                    rq.MAJIntfromId("reservation", "nbHeures", nb, idReservation, "idReservation");
    ...
    private void btnFactureActionPerformed(java.awt.event.ActionEvent evt) throws SQLException {//GEN-FIRST:event_btnFactureActionPerformed
    	String strFac = (String)JOptionPane.showInputDialog(null, "Veuillez choisir facture a editer", "Edition de facture", JOptionPane.QUESTION_MESSAGE, null, rq.getElementByIdFromTable("reservation", "Reservation", "idReservation"), rq.getElementByIdFromTable("reservation", "Reservation", "idReservation")[0]);
