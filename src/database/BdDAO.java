...
public class BdDAO {
     ...
     */
        public String[] getInfosReservation(int idReservation) throws SQLException{
            ...
            String nom = "SELECT nom, prenom FROM client, reservation WHERE clients.idClient=r�servations.fkidClient AND r�servations.idReservation="+idReservation+"";
            ...
            String service = "SELECT libelle FROM optionServices, choix WHERE optionsServices.idOptionsServices=choix.fkidOptionsServices AND choix.fkidReservation="+idReservation+" AND optionsServices.nature='service'";
            String option = "SELECT libelle FROM optionServices, choix WHERE optionsServices.idOptionsServices=choix.fkidOptionsServices AND choix.fkidReservation="+idReservation+" AND optionsservices.nature='option'";
            String formule = "SELECT libelle FROM formule, reservations WHERE formule.idFormule=r�servations.fkidFormule AND r�servations.idReservation="+idReservation+"";
            String salle = "SELECT libelle FROM salle, infoSalle, salleResa WHERE infoSalle.fkidSalle=salles.idSalle AND sallesResa.fkidInfoSalle=infoSalle.idInfoSalle AND sallesResa.fkidReservation="+idReservation+"";
            String disposition = "SELECT libelle FROM salleResa, disposition, infoSalle WHERE infoSalle.fkidDisposition=disposition.idDisposition AND sallesResa.fkidInfoSalle=infoSalle.idInfoSalle AND sallesResa.fkidReservation='"+idReservation+"'";
        ...
        public String getNomClient(int idReservation) throws SQLException{
            String nom = "SELECT nom FROM client, reservation WHERE client.idClient=reservations.fkidClient AND reservations.idReservation='"+idReservation+"'";
            rs = co.query(nom);
            String name = "";
            while(rs.next()){
        ...
        public String getPrenomClient(int idReservation) throws SQLException{
            String prenom = "SELECT nom, prenom FROM client, reservation WHERE client.idClient=reservations.fkidClient AND reservations.idReservation='"+idReservation+"'";
            rs = co.query(prenom);
            String name = "";
            while(rs.next()){
       ...
       public int getIdOption(String choix) throws SQLException{
         ...
         public String[] getSalles(int idReservation) throws SQLException{
             String salle = "SELECT libelle FROM salle, infoSalle, salleResa WHERE infoSalle.fkidSalle=salle.idSalle AND sallesResa.fkidInfoSalle=infoSalle.idInfoSalle AND sallesResa.fkidReservation='"+idReservation+"'";
        ...
        */
        ...
        public boolean checkErreurAjout(String nomTable, String nom, String couleur) throws SQLException{
            ...
            String quest2 = "SELECT * FROM salle, tache WHERE salle.fkidCouleur = "+coul+" OR taches.codeCouleur = '"+couleur+"'";
        ...
        */
        ...
        public void ajoutSalleResa(int idReservation, String salle, String disposition) throws SQLException{
            String nouvelleSalle = "INSERT INTO salleResa (fkidReservation, fkidInfoSalle) VALUES ('"+idReservation+"', (SELECT idInfoSalle FROM infoSalle WHERE fkidSalle=(SELECT idSalle FROM salle WHERE libelle = '"+salle+"') AND fkiddisposition=(SELECT idDisposition FROM disposition WHERE libelle='"+disposition+"')))";
